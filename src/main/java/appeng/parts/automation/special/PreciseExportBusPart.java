...
public class PreciseExportBusPart extends ExportBusPart {
    ...
    public ConfigInventory getConfig() {
        if (this.stackConfig == null) {
            this.stackConfig = ConfigInventory.configStacks(63)
                                              .supportedTypes(appeng.parts.automation.StackWorldBehaviors.withExportStrategy())
    ...
    protected void attemptCrafting(StackTransferContext context, appeng.api.networking.crafting.ICraftingService cg,
    ...
    protected appeng.container.GuiIds.GuiKey getGuiKey() {
        return appeng.container.GuiIds.GuiKey.PRECISE_EXPORT_BUS;
    }
