...
import appeng.parts.automation.special.ODFilterHost;
import net.minecraft.entity.player.InventoryPlayer;

public class ContainerODFilterBus<T extends appeng.api.upgrades.IUpgradeableObject & ODFilterHost> extends UpgradeableContainer<T> {
