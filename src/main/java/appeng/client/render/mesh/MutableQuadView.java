...
public interface MutableQuadView extends QuadView {
    ...
    default void pos(int vertexIndex, Vector3f pos) {
        pos(vertexIndex, pos.x, pos.y, pos.z);
    }
     ...
     *
     * <p>
     * Null by default, and set automatically by {@link #cullFace(EnumFacing)}.
     *
     * <p>
     ...
     * {@link BakedQuad#getVertexData() quad vertex data} is copied. This method should be performant whenever caller's
     * vertex representation makes it feasible.
     *
     * <p>
     * Use {@link #fromVanilla(BakedQuad, EnumFacing)} when you already have a full {@link BakedQuad} and optional
     * cull-face information, unless you have a specific reason to work with raw vertex data.
     *
     * <p>
     ...
     *
     * <p>
     * The quad's shading-related state is derived from the source quad. In particular,
     * {@link BakedQuad#shouldApplyDiffuseLighting()} is copied into this quad view's shade flag, while the
     * {@code cullFace} parameter controls the quad's cull face independently of the baked quad's light face.
     */
    void fromVanilla(BakedQuad quad, @Nullable EnumFacing cullFace);
}
