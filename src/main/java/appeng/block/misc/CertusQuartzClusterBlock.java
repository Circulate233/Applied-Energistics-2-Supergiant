...
public class CertusQuartzClusterBlock extends AEBaseBlock {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return this == appeng.core.definitions.AEBlocks.QUARTZ_CLUSTER.block()
    ...
    public int quantityDropped(Random random) {
        return this == appeng.core.definitions.AEBlocks.QUARTZ_CLUSTER.block() ? 4 : 1;
    }

    @Override
    public int quantityDroppedWithBonus(int fortune, Random random) {
        if (this != appeng.core.definitions.AEBlocks.QUARTZ_CLUSTER.block()) {
            return 1;
        }
