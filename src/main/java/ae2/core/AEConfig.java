...
public class AEConfig {
    ...
    public static CraftingCPU CRAFTING_CPU = new CraftingCPU();
    ...
    public static PowerRatios POWER_RATIOS = new PowerRatios();

    @Config.Name("spatial")
    public static Spatial SPATIAL = new Spatial();

    @Config.Name("vibrationChamber")
    public static VibrationChamber VIBRATION_CHAMBER = new VibrationChamber();
    ...
    public static TickRateConfig TICK_RATES = new TickRateConfig();
    ...
    public static class VibrationChamber {
    ...
    public static class Client {
        ...
        public boolean beamFormerLowCostRendering = false;
    ...
    public static class TickRateConfig {
    ...
    public static class TickRateRange {
        @Config.Name("min")
